...
const ReviewHeader = () => {
  return (
    <div className="flex justify-center items-center p-2">
      <nav
        x-data="{ isOpen: false }"
        className="bg-white rounded-[20px] w-[90%] shadow dark:bg-gray-800"
      >
            ...
            <div className="absolute inset-x-0 z-20 flex-1 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center lg:justify-between">
              ...
              <div className="flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
                <div className="flex  gap-2 justify-center items-center">
                  <Badge
                    variant="outline"
                    className="px-3 flex gap-3 justify-between items-center py-2 w-[fit-content] h-[50px] rounded-[25px]"
                  >
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="flex justify-center items-center gap-2">
                <Select>
                  <SelectTrigger className="w-[180px] rounded-[25px] h-[50px] border border-yelow-400 p-4">
                    <SelectValue placeholder="Filter Platforms" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup>
                      <SelectLabel>Select Platforms</SelectLabel>

                      <SelectItem value="apple">All</SelectItem>
                      <SelectItem value="banana">Google</SelectItem>
                      <SelectItem value="blueberry">Yelo</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
